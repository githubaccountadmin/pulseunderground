document.addEventListener('DOMContentLoaded', async function () {
    ...
    function displayNews(newsContent, reporterAddress, timestamp) {
        ...
        const actionButtons = `
            <div class="report-actions">
                ...
                <button class="report-action-button dispute-button" onclick="disputeNews('${reporterAddress}')">
    ...
    function disputeNews(reporterAddress) {
        console.log(`Dispute news by reporter: ${reporterAddress}`);
